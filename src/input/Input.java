...
public class Input extends UserActions implements Observerable{
	...
	public Input(Physics physics){
		super();
		keyBindings.put(KeyEvent.VK_W, new Move(0, -0.5));
		keyBindings.put(KeyEvent.VK_A, new Move(-0.5, 0));
		keyBindings.put(KeyEvent.VK_S, new Move( 0, 0.5));
		keyBindings.put(KeyEvent.VK_D, new Move( 0.5, 0));
